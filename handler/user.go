...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	formatter := user.FormatUser(newUser, "token-jwt")
...
func (h *userHandler) Login(c *gin.Context) {
	...
	formatter := user.FormatUser(loggedInUser, "token-jwt")

	response := helper.APIResponse("Account logged in successfully", http.StatusOK, "success", formatter)
